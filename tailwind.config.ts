  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        mono: ['ui-monospace', 'SF Mono', 'Roboto Mono', 'Menlo', 'Monaco', 'Consolas', 'Liberation Mono', 'Courier New', 'monospace'],
      },
      colors: {
      ...
      boxShadow: {
        'card': '0 8px 32px -4px rgba(0, 0, 0, 0.12), 0 4px 16px -2px rgba(0, 0, 0, 0.08)',
        'card-dark': '0 8px 24px -4px rgba(0, 0, 0, 0.4), 0 4px 12px -2px rgba(0, 0, 0, 0.3)',
      },
      keyframes: {
        "accordion-down": {
          from: {
